...
node("master") {
  ...
  stage ('Terraform Plan') {
    sh "cd /var/lib/jenkins/workspace/Terraform-VPC-New_master && /usr/local/bin/terraform plan -out=create.tfplan /var/lib/jenkins/workspace/Terraform-VPC-New_master"
  }
